...
REM
REM Generated by Vivado on Tue May 30 21:44:14 +0800 2023
...
echo "xvlog --incr --relax -prj hw2_3_tb_vlog.prj"
call xvlog  --incr --relax -prj hw2_3_tb_vlog.prj -log xvlog.log
